...
def get_retriever_from_excel() :
    ...
    documents1 = prepare_documents_from_excel(r"C:\Users\User\Desktop\langgraph\data\openai_result.xlsx", "competencies")
    documents2 = prepare_documents_from_excel(r"C:\Users\User\Desktop\langgraph\data\openai_result.xlsx", "roles")
